...
visible_functions = [
    ...
    # Json functions
    [['json_extract_int'], 'INT', ['JSON', 'VARCHAR'],
        'fake_symble_for_no_vec', '', '',
        'vec', 'ALWAYS_NULLABLE'],
    [['json_extract_int'], 'INT', ['JSON', 'STRING'],
        'fake_symble_for_no_vec', '', '',
        'vec', 'ALWAYS_NULLABLE'],
    [['json_extract_bigint'], 'BIGINT', ['JSON', 'VARCHAR'],
        'fake_symble_for_no_vec', '', '',
        'vec', 'ALWAYS_NULLABLE'],
    [['json_extract_bigint'], 'BIGINT', ['JSON', 'STRING'],
        'fake_symble_for_no_vec', '', '',
        'vec', 'ALWAYS_NULLABLE'],
    [['json_extract_double'], 'DOUBLE', ['JSON', 'VARCHAR'],
        'fake_symble_for_no_vec', '', '',
        'vec', 'ALWAYS_NULLABLE'],
    [['json_extract_double'], 'DOUBLE', ['JSON', 'STRING'],
        'fake_symble_for_no_vec', '', '',
        'vec', 'ALWAYS_NULLABLE'],
    [['json_extract_string'], 'STRING', ['JSON', 'VARCHAR'],
        'fake_symble_for_no_vec', '', '',
        'vec', 'ALWAYS_NULLABLE'],
    [['json_extract_string'], 'STRING', ['JSON', 'STRING'],
        'fake_symble_for_no_vec', '', '',
        'vec', 'ALWAYS_NULLABLE'],
    [['json_exists_path'], 'BOOLEAN', ['JSON', 'VARCHAR'],
        'fake_symble_for_no_vec', '', '',
        'vec', ''],
    [['json_exists_path'], 'BOOLEAN', ['JSON', 'STRING'],
        'fake_symble_for_no_vec', '', '',
        'vec', ''],
    [['json_type'], 'STRING', ['JSON', 'STRING'],
        'fake_symble_for_no_vec', '', '',
        'vec', 'ALWAYS_NULLABLE'],
    [['json_type'], 'STRING', ['JSON', 'STRING'],
        'fake_symble_for_no_vec', '', '',
